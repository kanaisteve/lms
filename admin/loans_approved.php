<?php 
    ...
    if(isset($_GET['disburse'])  && !empty($_GET['disburse'])) {
        $disburse_id = $_GET['disburse'];
        $loanObj->disburseLoan($disburse_id);
    }
?>
			        	...
			        	<div class="col-lg-12">
			        		<div class="card card-default">
			        			...
			        			<div class="card-body" style="overflow-y: auto;">
                                    <?php 
                                        $sn = 1;
                                        $loans = $loanObj->fetchApprovedLoans();
                                        if($loans !== false) :
			        				...
			        				<table class="table table-hover" id="approved-table">
			        					...
			        					<tbody>
			        						<tr>
			        							...
			        							<td><?= $loan['earning']; ?></td>
			        							<td><span class="badge badge-info"><?= $loan['loan_status']; ?></span></td>
			                                    <td>
                                                    <a href="viewCustomer.php?mobile=<?= $loan['mobileno'] ?>" class="btn btn-sm btn-primary"><span class="far fa-eye"></span></a>
                                                    <a href="loans_approved.php?disburse=<?= $loan['mobileno'] ?>" class="btn btn-sm btn-success"><span class="fas fa-check"></span> Disburse</a>
			                                    </td>
			        						</tr>
								        	<?php
								        	    $sn++;
