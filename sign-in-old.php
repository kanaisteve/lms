...
if(isset($_POST["signin"])) {
    ...
    $check_email_mobileno = "SELECT * FROM lms_users WHERE mobilenumber='$username' OR email='$username' LIMIT 1";
    
    $result = $mysqli->query($check_email_mobileno);
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $select_email_mobileno = "SELECT id, firstname, lastname, email, mobilenumber, userpassword FROM lms_users WHERE email= ? OR mobilenumber = ? LIMIT 1";
        
        
        if($stmt = $mysqli->prepare($select_email_mobileno)){
            ...
            if($stmt->execute()){
                ...
                if($stmt->num_rows == 1){                    
                  ...
                  $stmt->bind_result($id, $firstname, $lastname, $email, $mobilenumber, $hashed_password);
